...
${license}`
                ...
                writeToFile("testREADME.md", allInfoFormattedAsMD);
            })
            //if the axios call doesn't work, the below message is logged
            .catch((err) => console.log("User not found"));
      //this is the error handling for the whole async function      
    } catch (err) {
        console.log(err);
    }
}
